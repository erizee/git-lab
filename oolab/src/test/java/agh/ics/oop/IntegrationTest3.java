...
//        testAnimal.move(MoveDirection.LEFT);
//        assertEquals(testAnimal.getOrient(), MapDirection.NORTH);
//        MoveDirection[] moves = {MoveDirection.FORWARD, MoveDirection.RIGHT, MoveDirection.FORWARD, MoveDirection.RIGHT, MoveDirection.RIGHT, MoveDirection.BACKWARD, MoveDirection.BACKWARD};
//        String[] movesString = {"f", "right", "forward", "r", "x", "right", "b", "backward"};
//        assertArrayEquals((new OptionParser()).parse(movesString), moves);
